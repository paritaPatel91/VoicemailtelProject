...
//    public void TC_6_1(String email, String pass) throws InterruptedException {
//
//        ExtentTest test = EmailReport.createTest("joinMeetingTest");
//
//        test.log(Status.INFO, "Following Data Passed Email " + email + "Password" + pass);
//
//        JoinMeeting signIn = new JoinMeeting(driver);
//        signIn.getSignInMenu().click();
//        signIn.enterRegisteredEmail(email)
//                .enteredREgisteredPassword(pass)
...
// With invalid Moderator's email id
    ...
    public void TC_6_2(){
        ...
        test.log(Status.INFO, "Following data");
